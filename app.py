...
SMTP_PORT = 587
SMTP_USER = "pjallauca@espe.edu.ec"  # Configura tu correo institucional o de laboratorio
SMTP_PASSWORD = "ybueaikqihcltgra" # Contraseña de aplicación generada en tu cuenta de Google
